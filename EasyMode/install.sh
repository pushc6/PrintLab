...
echo ListenPort = 51928 >> /etc/wireguard/wg0.conf; echo privkey is $(sudo cat /etc/wireguard/privatekey); echo PrivateKey = $(sudo cat /etc/wireguard/privatekey) >> /etc/wireguard/wg0.conf"
